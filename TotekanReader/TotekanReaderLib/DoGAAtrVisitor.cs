...
{
	public class DoGAAtrVisitor : DoGAAtrBaseVisitor<object>
	{
		public List<DoGAAtr> atrs = new List<DoGAAtr>();
		private DoGAAtr atr = null;
		private string pathAtr;

		public DoGAAtrVisitor(string pathAtr)
		{
			this.pathAtr = pathAtr;
		}

		public override object VisitOnAtrs(DoGAAtrParser.OnAtrsContext context)
		{
			var result = base.VisitOnAtrs(context);
			return this.atrs;
		}
		...
		public override object VisitOnAtr(DoGAAtrParser.OnAtrContext context)
		{
			...
			this.atr = new DoGAAtr(nameAtr, this.pathAtr);
